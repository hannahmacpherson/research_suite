...
def typing_report_analyser():
    ...
    non_matched_typing_reports = [
        file for file in typing_files_list_checked if file not in list_of_typing_files_matched]
    ...
    for typing_file, fastq_file in list_of_matched_files:
        set_off_typing_report(imported_fmp_types,
                              log_of_past_uploads, typing_file, fastq_file)
